...
const MIGRATION_GUIDE_URL =
	"https://github.com/earendil-works/tau-mono/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL =
	"https://github.com/earendil-works/tau-mono/blob/main/packages/coding-agent/docs/extensions.md";
...
/**
 * Migrate sessions from ~/.tau/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.tau/agent/ instead of
 * ~/.tau/agent/sessions/<encoded-cwd>/. This migration moves them
 * to the correct location based on the cwd in their session header.
 *
 * See: https://github.com/earendil-works/tau-mono/issues/320
 */
