...
import { encodeCwdForPath, getAgentDir as getDefaultAgentDir, getSessionsDir } from "../config.ts";
 ...
 * Encodes cwd into a safe directory name under ~/.tau/agent/sessions/.
 */
function getDefaultSessionDirPath(cwd: string, agentDir: string = getDefaultAgentDir()): string {
	const resolvedAgentDir = resolvePath(agentDir);
	return join(resolvedAgentDir, "sessions", encodeCwdForPath(cwd));
}
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.tau/agent/sessions/<encoded-cwd>/).
	 */
