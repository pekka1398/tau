...
export class FileSettingsStorage implements SettingsStorage {
	...
	constructor(cwd: string, agentDir: string) {
		...
		this.projectSettingsPath = join(getProjectDir(resolvedCwd, resolvedAgentDir), "settings.json");
	}
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.TAU_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.TAU_HARDWARE_CURSOR === "1";
	}
